...
namespace Booking.DataAccess.Migrations
{
    ...
    [Migration("20231207081751_AddedPropertyEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Booking.DataAccess.Entities.Amenity", b =>
                {
            ...
            modelBuilder.Entity("Booking.DataAccess.Entities.BookedNight", b =>
                {
            ...
            modelBuilder.Entity("Booking.DataAccess.Entities.Property", b =>
                {
                    b.Property<int>("PropertyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Booking.DataAccess.Entities.Amenity", b =>
                {
                    b.HasOne("Booking.DataAccess.Entities.Property", null)
                        .WithMany("Amenities")
            ...
            modelBuilder.Entity("Booking.DataAccess.Entities.BookedNight", b =>
                {
                    b.HasOne("Booking.DataAccess.Entities.Property", "Property")
